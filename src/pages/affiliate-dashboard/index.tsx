...
function Dashboard() {
  async function fetchAffiliate() {
    ...
    const res = await fetch(`${baseUrl}/affiliates/get-affiliate?afilliate_id=${_id}`)
    const data = await res.json()
    console.log(data)
    return data
  }
  const { isLoading, data: affiliate } = useQuery({ queryKey: ['active_affiliate'], queryFn: fetchAffiliate })
